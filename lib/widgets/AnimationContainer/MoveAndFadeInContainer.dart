...
class MoveAndFadeInContainer extends StatefulWidget {
  ...
  @override
  State<MoveAndFadeInContainer> createState() => _MoveAndFadeInContainerState();
}

class _MoveAndFadeInContainerState extends State<MoveAndFadeInContainer> {
  @override
